...
MUD's goal is to find the ullage location and size. On Earth, the ullage, which is the pocket of gas in a closed container of fluid, sits at the top. In microgravity, the ullage sits in the middle of a tank, and the liquid evenly distributes to the walls of the tank.
...
During fuel transfer, ullage transfer with fuel can cause numerous problems. Our sister project, microgravity ullage trapping, works to move ullage. MUD uses five PZT patches, including an actuator, which produce white noise, allowing us to track the ullage location and the location of liquid propellant in the tank.
